                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Custom Login Page</h1>
                                    ...
                                    <form id ="formLogin" class="user" method="POST" action="/login">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input name = "remember-me"type="checkbox" class="custom-control-input" id="remember-me">
                                                <label class="custom-control-label" for="remember-me">Remember
                                                    Me</label>
                                            </div>
                                        </div>
                                        <a href="javascript:formLogin.submit();" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
